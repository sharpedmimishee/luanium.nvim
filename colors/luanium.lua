...
local hl = {
    ...
    ["@markup.heading"] = { fg = c.gosu },
    ["@markup.heading.1"] = { fg = c.ura },
    ["@markup.heading.2"] = { fg = c.heki },
    ["@markup.heading.3"] = { fg = c.usugunjo },
    ["@markup.heading.4"] = { fg = c.misora },
    ["@markup.heading.5"] = { fg = c.ai },
    ["@markup.heading.6"] = { fg = c.gosu },
